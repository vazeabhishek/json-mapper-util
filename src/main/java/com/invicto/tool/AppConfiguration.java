...
@Configuration
@ComponentScan({ "com.invicto.tool" })
    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.invicto.tool");
                servletContext.setInitParameter("tapestry.development-modules", "com.invicto.tool.services.DevelopmentModule");
